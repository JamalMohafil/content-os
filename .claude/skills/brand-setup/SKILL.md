...
6. **Fonts** — a font they use, or should I recommend one for the vibe + language?
...
- **Fonts** — a heading font + a Latin/number font. Recommend real Google Fonts; for Arabic prefer **Cairo / Tajawal / Baloo Bhaijaan 2 / IBM Plex Sans Arabic**. Note the exact Google Fonts URL.
...
```json
{
  ...
  "fonts": { "heading": "", "latin": "", "googleFontsUrl": "" },
...
- The fonts + the Google Fonts `<link>` to paste into templates.
